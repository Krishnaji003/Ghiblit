      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 text-xs text-ghibli-dark/70 text-center sm:text-right">
            ...
            <a href="https://www.linkedin.com/in/krishna-pawar-a64a22104/" className="hover:text-ghibli-dark transition-colors hover:underline" target="_blank" rel="noopener noreferrer">
              Built by @Krishna
            </a>
          </div>
        </div>
